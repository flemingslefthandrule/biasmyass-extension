export const AuthorDetails = (props) => {
  ...
  return (
      <a
          href={authorUrl}
          target="_blank"
          className="max-h-[56px] flex justify-center items-center p-2 gap-x-2 border-solid border-white border-2 rounded-md overflow-hidden cursor-pointer">
          <img
              className="rounded-[50%] object-cover w-[35px] h-[35px] max-w-[35px] max-h-[35px]"
              src={authorPhoto}
              alt="authorPhoto"
          />
